...
<title>Reportes de Categorias</title>
</head>
<body style="background-image: url('imagenes/FondoAdmin.png'); background-repeat: no-repeat;background-image: fixed;
	...
	<div class="Titulo"><h2 style="font-family: 'Anton', sans-serif; margin-left:30px">Reportes: Categorías</h2></div>
	<div class="SubTitulo">Por defecto se muestran las estadisticas
		del actual semestre</div>
	...
	<div class="panelFechaReporte">
		<form action="ServletReporteCategorias" method="get">
	...
	<div style="height:40px; width: 400px; margin-top:-745px; margin-left:580px">
		<h3 style="font-family: 'Nerko One', cursive;">Porcentajes de ventas por categoría</h3>
	</div>
	...
	<script type="text/javascript">
		...
		var etiquetas = JSON.parse('${categorias}');
