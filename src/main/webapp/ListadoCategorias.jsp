...
<body style="background-image: url('imagenes/FondoAdmin.png'); background-repeat: no-repeat;background-image: fixed;
	...
	<div class="titulo" style="background: center;"><h2 style="font-family: 'Patua One', cursive; font-size:30px; margin-left:35px;  width: 370px; margin-top: -25px">Categorías en el sistema:</h2></div>

	<div class="panelBusqueda" style="height:100px">
		<form action="ServletListadoCategorias" method="post">
			Buscar por descripción <input type="text" name="txtBusqueda" placeholder="Descripción categoría" class="btn btn-light">
	...
	<div class="tablaCategorias" style="margin-top:25px">
