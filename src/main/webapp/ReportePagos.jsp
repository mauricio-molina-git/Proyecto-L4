...
<jsp:include page="MenuAdmin.jsp"></jsp:include>
	...
	<div class="Titulo"><h2 style="font-family: 'Anton', sans-serif; margin-left:30px">Reportes: forma de pago</h2></div>
	...
	<div class="panelFechaReporte">
		<form action="ServletReportePagos" method="get">
	...
	<div style="height:40px; width: 400px; margin-top:-745px; margin-left:580px">
		<h3 style="font-family: 'Nerko One', cursive;">Porcentajes de ventas por metodo de pago:</h3><br>
		<h3 style="font-family: 'Nerko One', cursive;">C = Crédito / D = Débito</h3><br>
	</div>
	
		<div id="content-graf" style="margin-left:25%; margin-top:10%; position:absolute;">
	...
	<br><br>
		...
		var etiquetas = JSON.parse('${metodos}');
		...
		var chart = new Chart(ctx, {
			...
			data : {
				datasets : [ {
					label : '% de ventas',
					data : valores,
					backgroundColor : [ '#42a5f5', '#FAFA1F', 'green', 'blue',
							'grey' ]
				} ],
				labels : etiquetas
			},
